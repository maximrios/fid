...
ClientTemplate;
    ...
    */
    public function get_info_item() {
        ...
        $vcXHtml = '<div class="informacion-paginador col-lg-4 pull-right"><span class="item-contenedor">Cantidad total de registros '. $this->total_rows.'</span>'.
               '<span class="item-separador">|</span>'.
               '<span class="item-contenedor">Página '.$this->cur_page.' de '.$num_pages.'</span><span class="item-separador">&nbsp;</span></div>';
        return $vcXHtml;
    }
...
public function get_per_page_item() {
    ...
    $vcXHtml = '<div class="mostrar center-block col-lg-4 hidden-sm hidden-md"><span class="item-contenedor">Mostrar: </span>'.$select.'</div>';
...
*/  
    public function do_links() {
        ...
        if ($num_pages > 1) {
            ...
            $this->full_tag_open = '<div class="paginationes">';
            $this->full_tag_close = '</div>';
            $this->pager_tag_open = '<ul class="pagination col-lg-4 pull-left">';
            $this->pager_tag_close = '</ul>';
            // Render the "previous" link
            $output .= $this->pager_tag_open;
